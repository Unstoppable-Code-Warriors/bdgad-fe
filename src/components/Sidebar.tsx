    ...
    >
      ...
      <Box p="md" className="border-b border-gray-700">
        <Group>
          ...
          {!isCollapsed && (
            <Text c="cyan" fw={700} size="xl">BDGAD</Text>
          )}
        </Group>
      </Box>
      ...
      <Box p="md">
        {!isCollapsed && (
          <Text size="sm" fw={600} c="gray.4" mb="md" tt="uppercase">Main</Text>
        )}
      ...
      <Box p="md">
        {!isCollapsed && (
          <Text size="sm" fw={600} c="gray.4" mb="md" tt="uppercase">Pages</Text>
        )}
