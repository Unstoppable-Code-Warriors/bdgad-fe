import { ActionIcon, Menu, Indicator, ScrollArea, UnstyledButton, Divider, Group, Text, Stack, Badge } from '@mantine/core'
...
const NotificationBell = () => {
    ...
    const getNotificationColor = (type: string, subType?: string) => {
        ...
        switch (type) {
            ...
            case 'analysis_task': return 'purple'
            case 'validation_task': return 'orange'
            default: return 'gray'
        }
    }
